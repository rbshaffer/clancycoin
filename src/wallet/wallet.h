...
#ifndef CLANCYCOIN_WALLET_WALLET_H
#define CLANCYCOIN_WALLET_WALLET_H
...
enum WalletFlags : uint64_t {
    ...
    //! clancycoin from opening the wallet, thinking it was newly created, and
 ...
 * change.
 *
 * The Clancycoin Core wallet was originally a collection of unrelated private
...
public:
     ...
     * on this clancycoin node, and set to 0 for transactions that were created
...
#endif // CLANCYCOIN_WALLET_WALLET_H
