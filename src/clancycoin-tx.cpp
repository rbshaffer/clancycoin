...
static void SetupClancycoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " clancycoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  clancycoin-tx [options] <hex-tx> [commands]  Update hex-encoded clancycoin transaction\n" +
            "or:     clancycoin-tx [options] -create [commands]   Create hex-encoded clancycoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded clancycoin transaction
