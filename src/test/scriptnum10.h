...
#ifndef CLANCYCOIN_TEST_SCRIPTNUM10_H
#define CLANCYCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Clancycoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // CLANCYCOIN_TEST_BIGNUM_H
