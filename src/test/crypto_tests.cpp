...
BOOST_AUTO_TEST_CASE(sha256_testvectors) {
    ...
    TestSHA256("As Clancycoin relies on 80 byte header hashes, we want to have an example for that.",
               "6b468056936fef23996dd3b22c30268da4472509ffe1bf42f659c18bb8e3f18a");
