// Copyright (c) 2012-2019 The Clancycoin Core developers
...
{
    BOOST_CHECK(TestSplitHost("www.clancycoincore.org", "www.clancycoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.clancycoincore.org]", "www.clancycoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.clancycoincore.org:80", "www.clancycoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.clancycoincore.org]:80", "www.clancycoincore.org", 80));
