...
#ifndef CLANCYCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define CLANCYCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // CLANCYCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
