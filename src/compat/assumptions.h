...
#ifndef CLANCYCOIN_COMPAT_ASSUMPTIONS_H
#define CLANCYCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Clancycoin cannot be compiled without assertions."
#endif
...
#endif // CLANCYCOIN_COMPAT_ASSUMPTIONS_H
