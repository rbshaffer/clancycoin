...
#ifndef CLANCYCOIN_SCRIPT_STANDARD_H
#define CLANCYCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a clancycoin address
 */
...
/**
 * Generate a Clancycoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // CLANCYCOIN_SCRIPT_STANDARD_H
