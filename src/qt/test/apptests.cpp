...
//! Entry point for ClancycoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &ClancycoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for ClancycoinGUI tests.
void AppTests::guiTests(ClancycoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &ClancycoinGUI::consoleShown, this, &AppTests::consoleTests);
