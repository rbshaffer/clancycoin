...
#ifndef CLANCYCOIN_QT_SPLASHSCREEN_H
#define CLANCYCOIN_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. Clancycoin Core initialization
...
#endif // CLANCYCOIN_QT_SPLASHSCREEN_H
