    ...
    mapper(nullptr)
{
    ...
    ui->clancycoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->clancycoinAtStartup);
    ...
    ui->clancycoinAtStartup->setToolTip(ui->clancycoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->clancycoinAtStartup->setText(ui->clancycoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openClancycoinConfButton->setToolTip(ui->openClancycoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new ClancycoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->clancycoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openClancycoinConfButton_clicked()
{
