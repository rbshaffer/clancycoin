    ...
    platformStyle(_platformStyle)
{
    ...
    // normal clancycoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying clancycoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &ClancycoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
