...
#ifndef CLANCYCOIN_QT_CLANCYCOINUNITS_H
#define CLANCYCOIN_QT_CLANCYCOINUNITS_H
...
/** Clancycoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ClancycoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ClancycoinUnits(QObject *parent);

    /** Clancycoin units.
      @note Source: https://en.clancycoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef ClancycoinUnits::Unit ClancycoinUnit;

#endif // CLANCYCOIN_QT_CLANCYCOINUNITS_H
