...
#ifndef CLANCYCOIN_INTERFACES_NODE_H
#define CLANCYCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a clancycoin node (clancycoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // CLANCYCOIN_INTERFACES_NODE_H
