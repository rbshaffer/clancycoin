...
#ifndef CLANCYCOIN_KEYSTORE_H
#define CLANCYCOIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/clancycoin/bips/blob/master/bip-0013.mediawiki
