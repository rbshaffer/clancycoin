...
"""Verify that starting clancycoin with -h works as expected."""

from test_framework.test_framework import ClancycoinTestFramework
from test_framework.util import assert_equal

class HelpTest(ClancycoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start clancycoin with -h for help text")
        ...
        self.log.info("Start clancycoin with -version for version information")
        ...
        self.log.info("Start clancycoind with -fakearg to make sure it does not start")
