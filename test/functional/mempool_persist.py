...
By default, clancycoind will dump mempool on shutdown and
...
class MempoolPersistTest(ClancycoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent clancycoind from writing mempool.dat to disk. Verify that `savemempool` fails")
