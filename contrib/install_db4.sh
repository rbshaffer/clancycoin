...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the clancycoin repository."
  exit 1
fi
...
# See https://github.com/clancycoin/clancycoin/issues/16064
...
echo
echo 'When compiling clancycoind, run `./configure` in the following way:'
echo
