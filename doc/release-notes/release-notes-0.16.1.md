Clancycoin Core version 0.16.1 is now available from:

  <https://clancycoincore.org/bin/clancycoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting clancycoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure clancycoind processes are cleaned up when tests end (sdaftuar)
