Clancycoin Core version 0.9.4 is now available from:

  https://clancycoin.org/bin/0.9.4/
...
this update is incompatible with the Clancycoin system and could lead to consensus
forks.

Clancycoin Core released binaries from https://clancycoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~clancycoin/+archive/ubuntu/clancycoin
- A third-party or self-compiled Clancycoin Core

upgrade to Clancycoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
