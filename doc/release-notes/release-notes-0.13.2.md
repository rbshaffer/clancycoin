Clancycoin Core version 0.13.2 is now available from:

  <https://clancycoin.org/bin/clancycoin-core-0.13.2/>
...
- #8908 `4a974b2` Update clancycoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow clancycoin-tx to create v2 transactions (btcdrak)
