Clancycoin Core version *0.14.3* is now available from:

  <https://clancycoin.org/bin/clancycoin-core-0.14.3/>
...
- #10451 `3612219` contrib/init/clancycoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
