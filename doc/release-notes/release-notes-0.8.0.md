Clancycoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/clancycoin/files/Clancycoin/clancycoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Clancycoin
...
New/changed settings (command-line or clancycoin.conf file)
--------------------------------------------------------
