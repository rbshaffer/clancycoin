Clancycoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/clancycoin/files/Clancycoin/clancycoin-0.5.4/
...
http://gitorious.org/clancycoin/clancycoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Clancycoin-Qt notifications under Growl 1.3.
Increase required age of Clancycoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxClancycoin properly when installing Clancycoin-Qt over it. (Windows)
