Clancycoin Core version 0.10.4 is now available from:

  <https://clancycoin.org/bin/clancycoin-core-0.10.4/>
...
- #6953 `43c2789` Split clancycoin-tx into its own package
- #6953 `dfe0d4d` Include clancycoin-tx binary on Debian/Ubuntu
