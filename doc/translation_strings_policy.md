...
This document provides guidelines for internationalization of the Clancycoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `clancycoin_en.ts` remains unchanged.
